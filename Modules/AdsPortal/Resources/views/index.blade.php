							...
							<div class="card-body">
								...
								<div class="pt-1">
									<div class="rounded border p-5 p-lg-1">
										<div class="my-slider">
											<!-- AJAX data will be populated here -->
										</div>
			...
			$.ajax({
				...
				success: function(data) {
					...
					if (Array.isArray(data) && data.length > 0) {
						data.forEach(item => {
							slides += `<div class="text-center px-5 py-5"><img src="${item.url}" class="card-rounded mw-100" alt="" width="1280px" height="680px"></div>`;
						});
						slides += `<div class="text-center px-5 py-5"><img src="/modules/adsportal/img/YourAds.jpg" class="card-rounded mw-100" alt="" width="1280px" height="680px"></div>`;
					} else {
						slides = `<div class="text-center px-5 py-5"><img src="/modules/adsportal/img/YourAds.jpg" class="card-rounded mw-100" alt="" width="1280px" height="680px"></div>`;
					}

					// Append to the slider container
					$('.my-slider').html(slides);
					...
					var slider = tns({
						...
						slideBy: 'page',
						autoplay: true,
						autoplayButtonOutput: false, // Hides the autoplay button
						autoplayTimeout: 10000, // Autoplay interval set to 10s
						speed: 3000, // Transition speed
						controls: false, // Hide default controls (previous/next)
						nav: false
					});
				},
