...
class DepartmentDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query, Request $request): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('user_cid', function (Department $asset) {
                return $asset->user_cid ?? '-';
            })
            ->editColumn('created_at', function (Department $asset) {
            ...
            ->addColumn('action', function (Department $transaction) {
                return view('itam::department._actions', compact(['transaction']));
            })
            ->rawColumns(['action'])
            ->setRowId('id');
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->drawCallback("function() {" . file_get_contents($modulePath.'Resources/views/department/_draw-scripts.js') . "}");
    }
