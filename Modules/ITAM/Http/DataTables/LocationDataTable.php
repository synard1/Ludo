...
class LocationDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query, Request $request): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('user_cid', function (Location $asset) {
                return $asset->user_cid ?? '-';
            })
            ->editColumn('created_at', function (Location $asset) {
            ...
            ->addColumn('action', function (Location $transaction) {
                return view('itam::location._actions', compact(['transaction']));
            })
            ->rawColumns(['action'])
            ->setRowId('id');
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->drawCallback("function() {" . file_get_contents($modulePath.'Resources/views/location/_draw-scripts.js') . "}");
    }
