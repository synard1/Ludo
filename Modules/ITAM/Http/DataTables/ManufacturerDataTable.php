...
class ManufacturerDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query, Request $request): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('user_cid', function (Manufacture $asset) {
                return $asset->user_cid ?? '-';
            })
            ->editColumn('created_at', function (Manufacture $asset) {
            ...
            ->addColumn('action', function (Manufacture $transaction) {
                return view('itam::manufacturer._actions', compact(['transaction']));
            })
            ->rawColumns(['action'])
            ->setRowId('id');
    }

    public function query(Manufacture $model): QueryBuilder
    {
        $user = auth()->user();
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->drawCallback("function() {" . file_get_contents($modulePath.'Resources/views/manufacturer/_draw-scripts.js') . "}");
    }
