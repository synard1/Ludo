...
<script type="text/javascript">
    ...
    <script>
        ...
        $('#kt_modal_work_order_response_form').submit(function (e) {
                e.preventDefault();
                ...
                var formData = {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            submitButtonWOResponse.removeAttribute('data-kt-indicator');

                            // Enable button
                            submitButtonWOResponse.disabled = false;
        ...
        $("#finish_date").flatpickr({
            ...
            var tableWorkOrder = $('#workOrderTable').DataTable({
                ajax: {
