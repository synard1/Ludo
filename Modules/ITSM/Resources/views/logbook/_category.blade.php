<div class="card pt-4 mb-6 mb-xl-9">
    <div class="card-header collapsible cursor-pointer rotate">
        ...
        <div class="card-toolbar">
            <!--begin::Menu-->
            <button type="button" class="btn btn-primary" id="kt_new_service_category">
                <i class="ki-duotone ki-plus fs-2"></i> Make Service Category
            </button>
            <!--end::Menu-->
        </div>
        @endif
...
@include('itsm::service._formCategory')
@push('scripts')
<script>
    // Get the last day of the current month
        function getServiceCategory() {
            ...
            $("#serviceCategory-tables").DataTable().destroy();
        ...
        $('#serviceCategory-tables').on('click', '.edit-category', function(e) {
            e.preventDefault();
