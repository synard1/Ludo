...
<div class="card shadow-sm mb-5">
    ...
    <div id="kt_docs_card_incident_new" class="collapse">
        <!--begin::Form-->
        <form id="kt_new_incident_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
            ...
            <div class="card-body p-9">
                ...
                <div class="row mb-2">
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            <label class="required fs-6 fw-semibold mb-2">Incident Category</label>
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <select id="classification" name="classification" class="js-select2 form-control">
                                    ...
                                    @foreach ($incidentCategory as $category)
                                        <option value="{{ $category->id }}"><b>{{ $category->name }}</b> -- {{ $category->description }}</option>
                                    @endforeach
                            </select>
                            </div>
                            <!--end::Input-->
                ...
                <div class="row mb-2">
                    <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                            <label class="required fs-6 fw-semibold mb-2">Incident Name</label>

                            <!--begin::Input-->
                            <div class="position-relative d-flex align-items-center">
                                <input type="text" class="form-control form-control-solid"
                                    placeholder="Enter incident name" name="incident" id="incident">
                            </div>
                            <!--end::Input-->
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
            ...
            <div class="card-footer d-flex justify-content-end py-6 px-9">
                <button type="reset" class="btn btn-light btn-active-light-primary me-2 btn-cancel"
                    id="kt_new_incident_cancel">Discard</button>
