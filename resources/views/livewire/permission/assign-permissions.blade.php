<div class="modal fade" id="kt_modal_assign_permission" tabindex="-1" aria-hidden="true" wire:ignore.self>
    <!--begin::Modal dialog-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-7">
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input class="form-control form-control-solid" name="name" wire:model.defer="name" readonly/>
                    <!--end::Input-->
                    @error('name')
                ...
                <div class="fv-row">
                            <!--begin::Label-->
                            <label class="fs-5 fw-bold form-label mb-2">User Permissions</label>
                            <!--end::Label-->
                            <!--begin::Table wrapper-->
